...
void holdsteering(double degrees_F, double degrees_R) {
        ...
        double printing_deriv;
        // Serial.print(steer_error_F);
        // Serial.print(" ");
        // printing_deriv = (steer_error_F - prev_steer_error_F) / dt;
        // Serial.print(printing_deriv);
        // Serial.print(" ");
        // Serial.print(integral_steer_F);
        // Serial.print(" ");
        // Serial.print(frontSteerInput);
        // Serial.print("\t\t\t\t\t");
        // Serial.print(steer_error_R);
        // Serial.print(" ");
        // printing_deriv = (steer_error_R - prev_steer_error_R) / dt;
        // Serial.print(printing_deriv);
        // Serial.print(" ");
        // Serial.print(integral_steer_R);
        // Serial.print(" ");

...
void getMotorData() {
        ...
        ENCD1.Vel = (((double)cntEncd1 - (double)ENCD1.lastCnt) / dT) * Pos_Cnts2Rev; // [rev/s]
        ENCD2.Vel = (((double)cntEncd2 - (double)ENCD2.lastCnt) / dT) * Vel_Cnts2Rev;
        ENCD3.Vel = (((double)cntEncd3 - (double)ENCD3.lastCnt) / dT) * Pos_Cnts2Rev;
        ENCD4.Vel = (((double)cntEncd4 - (double)ENCD4.lastCnt) / dT) * Vel_Cnts2Rev;

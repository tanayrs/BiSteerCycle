...
if __name__ == '__main__':
    front_path = './Python/deadband tests/deadband loaded/SourceData/FrontSlope5Data_rotate.csv'
    rear_path = './Python/deadband tests/deadband loaded/SourceData/RearSlope5Data_rotate.csv'

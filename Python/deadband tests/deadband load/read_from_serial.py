...
if __name__ == '__main__':
    front_path = './Python/deadband tests/deadband load/SourceData10/FrontSlope20Data.csv'
    rear_path = './Python/deadband tests/deadband load/SourceData10/RearSlope20Data.csv'

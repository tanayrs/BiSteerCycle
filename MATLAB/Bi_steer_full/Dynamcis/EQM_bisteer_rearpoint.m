...
state    = [   x,    y,    V,    psi,  psidot,     phi,   phidot,    del,   deldot,    theta_R,    theta_F];
statedot = [xdot, ydot, Vdot, psidot, psiddot,  phidot,  phiddot, deldot,  delddot, theta_Rdot, theta_Fdot];
